<template>
    <div class="flex justify-between flex-col w-full h-full">
      <div class="flex-col gap-5 flex justify-start">
        <div
          class="gap-5 px-2 group inline-flex justify-star items-center text-teal-400  rounded-[15px] h-[40px]"
        >
          <svg
        ...
        <div
          class="gap-5 px-2 group inline-flex justify-star items-center text-teal-400 bg-teal-100 cursor-pointer rounded-[15px] h-[40px]"
        >
          <svg
            class="w-6 h-5 group-hover:text-teal-400 "
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 24 24"
          ...
          <div
            class="group-hover:text-teal-400 text-2xl font-bold"
          >
            <a href="#"
              >Tickets</a
            >
        ...
        <div
          ...
          >
            <svg
              class="group-hover:text-teal-400 w-6 h-6 text-neutral-400 dark:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 24 24"
      ...
      <div class="gap-5 px-2 group inline-flex justify-star items-center text-teal-400 cursor-pointer rounded-[15px] h-full]"
        >
          <svg
